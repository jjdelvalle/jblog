...
<figure>
  ...
  <figcaption>Fig. 4: Input distribution results. Distribution of input can be directly seen by comparing the middle bars.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Fig. 5: Format results.</figcaption>
</figure>

<figure>
  <a href="{{site.url}}/assets/icl_labelspace.png"><img src="{{site.url}}/assets/icl_labelspace.webp" alt="Experiments on other factors."/></a>
  <figcaption>Fig. 6: Label space can be evaluated by looking at the middle bars.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Fig. 7: Experiment showing that ground-truth labels sometimes matter.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Fig. 8: Initial results from paper {% cite yoo-etal-2022-ground %}.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Fig. 9: Relative difficulty against sensitivity.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Fig. 10: Models get better at overriding semantic priors as they get larger.</figcaption>
</figure>

<figure>
  <a href="{{site.url}}/assets/icl_sul.png"><img src="{{site.url}}/assets/icl_sul.webp" alt="Unrelated label usage vs scale"/></a>
  <figcaption>Fig. 11: Models get better at making use of even unrelated labels in the prompt as they grow larger.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Fig. 12: Instruction tuned language models are worse at overriding semantic priors.</figcaption>
</figure>
